...
public class TelaLogin {
    ...
    private final JCheckBox lembrarMim = new JCheckBox("Lembrar de mim");

    LogginDAO logginDAO = new LogginDAO(txtLogin);

    public JTextField getTxtLogin() {
        return txtLogin;
    }

    public JCheckBox getLembrarmim(){
        return lembrarMim;
    }
...
//		Atribuindo Fun��es para os botoes
